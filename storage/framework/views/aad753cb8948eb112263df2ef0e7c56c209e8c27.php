<?php $__env->startSection('title'); ?>
    <?php echo e(__('Resume Source')); ?> | <?php echo e(config('app.name')); ?>
...
<div class="kt-portlet">
    <div class="kt-portlet__body">
        <div class="kt-portlet__content">
            ...
            <?php if(Laratrust::isAbleTo('create-resume-source')): ?>
                <a href="<?php echo e(route('master.resume-source.create')); ?>" class="btn btn-primary mb-4">
                    <i class="fa fa-plus"></i> <?php echo e(__('New Resume Source')); ?>
...
<?php $__env->startSection('script'); ?>
    <?php echo $__env->make('layouts.inc.modal.delete', ['object' => 'resume source'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    ...
    <script type="text/javascript">
        $('#kt_table_1').DataTable({
            ...
            ajax: {
                method: 'POST',
                url: '<?php echo e(route('master.resume-source.data')); ?>',
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\articles\resources\views/master/resume-source/index.blade.php ENDPATH**/ ?>