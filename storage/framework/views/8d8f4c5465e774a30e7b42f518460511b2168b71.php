<?php $__env->startSection('title'); ?>
    <?php echo e(__('Category')); ?> | <?php echo e(config('app.name')); ?>
...
<?php $__env->startSection('breadcrumb'); ?>
    <span class="kt-subheader__breadcrumbs-separator"></span><a href="<?php echo e(route('master.category.index')); ?>" class="kt-subheader__breadcrumbs-link"><?php echo e(__('Category')); ?></a>
<?php $__env->stopSection(); ?>
...
<div class="kt-portlet">
    <div class="kt-portlet__body">
        <div class="kt-portlet__content">
            ...
            <?php if(Laratrust::isAbleTo('create-category')): ?>
                <a href="<?php echo e(route('master.category.create')); ?>" class="btn btn-primary mb-4">
                    <i class="fa fa-plus"></i> <?php echo e(__('New Category')); ?>
...
<?php $__env->startSection('script'); ?>
    <?php echo $__env->make('layouts.inc.modal.delete', ['object' => 'category'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    ...
    <script type="text/javascript">
        $('#kt_table_1').DataTable({
            ...
            ajax: {
                method: 'POST',
                url: '<?php echo e(route('master.category.data')); ?>',
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\articles\resources\views/master/category/index.blade.php ENDPATH**/ ?>