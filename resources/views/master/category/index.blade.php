...
<div class="kt-portlet">
    <div class="kt-portlet__body">
        <div class="kt-portlet__content">
            ...
            @if (Laratrust::isAbleTo('create-category'))
                <a href="{{ route('master.category.create') }}" class="btn btn-primary mb-4">
...
@section('script')
    ...
    <script type="text/javascript">
        $('#kt_table_1').DataTable({
            ...
            ajax: {
                method: 'POST',
                url: '{{ route('master.category.data') }}',
